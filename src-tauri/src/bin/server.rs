...
//! Suitable for server/headless deployment on any Linux system (musl static).
...
fn print_help() {
    ...
    println!("  This binary is statically linked with musl libc.");
    println!("  It can run on any Linux distribution:");
    println!("  - CentOS 7+ (glibc 2.17)");
    println!("  - Ubuntu 18.04+ (glibc 2.27)");
    println!("  - Alpine Linux (musl libc)");
    println!("  - All other Linux systems");
}